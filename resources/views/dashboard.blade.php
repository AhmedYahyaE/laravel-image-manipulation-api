{{-- We edit this dashboard page (originally created by Breeze package that we used by typing in the command: "composer require laravel/breeze --dev") to show user's Sanctum personal access tokens --}}
